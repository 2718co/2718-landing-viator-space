...
const AuthButton = ({ label, onClick }: IAuthButtonProps) => {
    ...
    return (
        <button
            onClick={onClick}
            type="button"
            className="mb-2 mr-2 inline-flex w-full flex-row items-center justify-between rounded-2xl border border-gray-200 bg-white px-5 py-2.5 text-center text-2xl font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-100 "
        >

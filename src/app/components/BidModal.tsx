                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    {confirmingTransaction ? (
                      <>
                        ...
                        <div className="mt-4 mb-7 text-left text-subtitle-2-size text-light-text lg:px-4">
                          <p>
                            After the confirmation and the clearance, by the
                            Ethereum network, of your transaction your bid will
                            be finalized and will appear on this site.
                          </p>
                        </div>
                      </>
                    ) : (
                      <>
                        ...
                        <div className="mt-4 mb-7 text-left text-subtitle-2-size text-light-text lg:px-4">
                          <p>
                            The bid must be at least 0.05 ETH higher than the
                            previous bid. Starting bid was 0.1 ETH. The auction
                            ends exactly after 24 hours. Unless edition 27 is
                            auctioned the next auction will start immediately.
                          </p>
                        </div>
                      </>
                    )}

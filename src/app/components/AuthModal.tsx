...
const AuthModal = ({ open, setOpen }: IAuthModalProps): JSX.Element => {
    ...
    return (
        <Transition.Root show={open} as={Fragment}>
            <Dialog as="div" className="relative z-10 font-mono" initialFocus={cancelButtonRef} onClose={setOpen}>
                <Transition.Child
                    as={Fragment}
                                    ...
                                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        ...
                                        <div className="mt-7 text-left text-subtitle-2-size text-light-text lg:px-4 lg:text-center">
                                            <p>
                                                ...
                                                and acknowledge that you have read and understod the 2718&apos;s{' '}
                                                <Link
                                                    href={'/'}
                                                    target="_blank"
                                                    className="text-highlight underline hover:opacity-80"

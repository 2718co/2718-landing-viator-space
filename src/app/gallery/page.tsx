        ...
        <div className="flex flex-col justify-between px-1 lg:flex-row lg:space-x-8 lg:pl-6">
            <div className="relative h-min w-full lg:sticky lg:top-0 lg:h-screen lg:w-96">
                ...
                <div className="mt-3 hidden flex-col text-text-size font-normal text-white lg:flex">
                    ...
                    />
                    <p className="mt-3">
                        2718 is a native urban web3 culture brand at the intersection of urban fashion, technology, and
                        artistical expression. We thrive on collaborating and working together as a collective. We know
                        that passionate coordinated team work out works any person or entity. For this reason we
                        collectivize.
                    </p>
            ...
            {typeof window !== 'undefined' &&
                createPortal(<RedeemModal open={redeemModalOpen} setOpen={setRedeemModalOpen} />, document.body)}
        </div>
    );
};

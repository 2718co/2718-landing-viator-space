...
const ClaimPage = () => {
  ...
  return (
    <div className="grid place-items-center pt-40 pb-72">
      <div className="max-w-2xl">
        <Tab.Group>
          ...
          <Tab.Panels className="mt-2">
                ...
                <div className="absolute inset-x-0 top-1/2 h-[5px] w-full rounded-full bg-highlight">
                  ...
                  <div className="absolute inset-0 -top-1.5 flex w-full flex-row items-start justify-between">
                    <div className="relative">
                      ...
                      <div className="absolute left-0 -top-5 text-subtitle-2-size text-highlight">
                        Claim
                      </div>
                    </div>
                    <div className="relative">
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute right-0 -top-5 text-subtitle-2-size text-highlight">
                        Register
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex flex-1 flex-col justify-between space-y-3">
                  <div className="">
                    ...
                    <span className="text-text-size text-light-text">
                      Claim your custom 2718 address for no costs except network
                      fees. Follow the three steps to own your own piece of the
                      2718 journey.
                    </span>
                  </div>
                  <input
                    type="text"
                    className="rounded-xl bg-white py-6 px-4"
                  />
                  <div className="">
                    <button
              ...
              {currentClaimPage === ClaimProcess.Wait && (
                <div className="flex flex-1 flex-col justify-between space-y-3">
                  <div className="">
                    ...
                    <span className="text-text-size text-light-text">
                      Hang on for one minute while we ensure no other person has
                      tried to register the same name and while we try to
                      reserve your claim.
                    </span>
                  </div>
                  <div className="">
              ...
              {currentClaimPage === ClaimProcess.Register && (
                <div className="flex flex-1 flex-col justify-between space-y-3">
                  <div className="">
                    ...
                    <span className="text-text-size text-light-text">
                      Sign the second and last transaction to register and make
                      the domain name yours.{" "}
                    </span>
                  </div>
              ...
              {currentClaimPage === ClaimProcess.Save && (
                <div className="flex flex-1 flex-col justify-between space-y-3">
                  <div className="">
                    ...
                    <span className="text-text-size text-light-text">
                      Save your new ENS domain as your primary ENS name to
                      represent your Ethereum account and act as your
                      cross-platform web3 username and profile. You can only
                      have one primary ENS name. With this action any previous
                      name is overwritten.
                    </span>
                  </div>
            ...
            >
              <span className="text-text-size text-light-text">
                Select a domain to make it your primary ENS name to be used
